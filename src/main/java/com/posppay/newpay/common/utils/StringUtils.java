...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
     ...
     * @return BigDecimal
     */
    public static BigDecimal double2Bigdecimal(Double amt) {
        if (null != amt) {

            return new BigDecimal(amt).setScale(SCALE, RoundingMode.HALF_UP);
        }else {
            return null;
        }
    }
     ...
     * @return
     */
    public static BigDecimal double2decimal4yuan(double amt) {
        return new BigDecimal(amt).setScale(SCALE, RoundingMode.HALF_UP);
    }
