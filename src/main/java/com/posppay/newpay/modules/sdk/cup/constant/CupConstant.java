package com.posppay.newpay.modules.sdk.cup.constant;
...
public class CupConstant {
    ...
    /**银联成功返回码*/
    public static final String CUP_SUCCESS_CODE = "T";
    /**银联失败返回码*/
    public static final String CUP_FAILED_CODE = "F";
    /**银联交易查询标志*/
    public static final String CUP_NOT_QUERY_CODE = "N";
    /**终端交易待支付标志*/
    public static final String CUP_WAIT_PAY_CODE = "A";
    /**终端交易成功支付标志*/
    public static final String CUP_SUCCESS_PAY_CODE = "S";
    /**默认字符集*/
    ...
    /**银行账户对私、待进件状态、银联进件审核状态：未审核、交易请求通信成功*/
    ...
    public static final String IS_RAW = "1";
     ...
     * 不需要查询
     */
    public static final String CUP_NOT_NEED_CODE = "N";
    ...
    public static final class ServerName{
        ...
        /**C扫B交易请求*/
        public static final String UNIFIED_TRADE_JSAPI= "pay.weixin.jspay";
    }
